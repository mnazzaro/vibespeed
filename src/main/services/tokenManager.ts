...
import { AuthToken, SecureStorageData, GitHubInstallation, UserProfile } from '../../shared/types/auth';
...
export class TokenManager {
  ...
  public async saveInstallationToken(installationId: number, token: AuthToken): Promise<void> {
